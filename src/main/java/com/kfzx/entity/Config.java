...
public class Config {
	...
	/**
	 * 网址   http://www.baiduc.com
	 */
	private String web_site;
	/**
	 * head头里面的东西     1=高速模式  2=jq  3=网站小图标
	 */
	 ...
	 * 首页 关键词
	 */
	private String index_page_keywords;
	/**
	 * 首页  描述 摘要
	 */
	private String index_page_description;
	/**
	 * 备案信息
	 */

	private String beian_;
	/**
	 * 记录这个软件 的版本号,根据不同的版本 更新不同的功能。 以后做更新的详细记录步骤
	 */
